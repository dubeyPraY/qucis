          ...
          <div className="md:w-[60%]">
            <div className="text-white">
              ...
              <p className="mt-8 font-source text-[16px] md:text-[20px] font-light tracking-[0.48px]">
                ...
                with <b>Prof. Bane Vasi.</b> His research interests include
                classical and quantum information theory and coding, quantum
                optics, quantum cryptography, quantum algorithms, fault-tolerant
                quantum computation.
                <br />
                <br />
                He obtained Ph.D. from{" "}
                <b>
                  {" "}
                  the PNSIL Group of the Department of Electronic Systems
                  Engineering
                </b>{" "}
                at <b>the Indian Institute of Science, Bengaluru</b> under the
                supervision of <b>Prof. Shayan Srinivasa Garani.</b>
              </p>
            </div>
          </div>
          <div>
            <img
              src="/members/ANKUR.png"
